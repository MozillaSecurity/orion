...
then
  ...
  then
    if [[ $NYX_FUZZER = Domino* ]]
    then
      cat >> ./corpus/input0 << EOF
{
  "buffer": "aGVsbG8gd29ybGQ=",
  "entryPoints": {
    "fuzzer": "fuzzer.js",
    "objects": "objects.js",
    "timeout": "timeout.js"
  ...
  "resources": {
    "fuzzer.js": "Y29uc3QgY2FudmFzID0gZG9jdW1lbnQuY3JlYXRlRWxlbWVudCgiY2FudmFzIik7IGRvY3VtZW50LmJvZHkuYXBwZW5kQ2hpbGQoY2FudmFzKTtjYW52YXMuZ2V0Q29udGV4dCgid2ViZ2wyIik7IE55eC5yZWxlYXNlKCk=",
    "objects.js": "",
    "timeout.js": ""
  }
}
