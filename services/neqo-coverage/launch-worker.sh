...
if [[ ! -d firefox ]]; then
  ...
  git sparse-checkout set --no-cone /security/nss /nsprpub /third_party/rust/neqo-common/Cargo.toml
...
# Clone neqo
NEQO_VERSION="$(python package-version.py firefox/third_party/rust/neqo-common/Cargo.toml | tr -d "\n")"
